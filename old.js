      ...
      if (i < this.state.currentIndex) {
        ...
        return (
          <Animated.View key={item.id} {...this.PanResponder.panHandlers}
            ...
            <Animated.View style={{position: 'absolute', top: 50, left: 40, zIndex: 1000, opacity: this.likeOpacity, transform: [{rotate: '-30deg'}]}} >
              <Text style={{borderWidth:1, borderColor:'green', color: 'green', fontSize: 32, fontWeight: '800', padding: 10}} >LIKE</Text>
            </Animated.View>

            <Animated.View style={{position: 'absolute', top: 50, right: 40, zIndex: 1000, opacity: this.dislikeOpacity, transform: [{rotate: '30deg'}]}} >
